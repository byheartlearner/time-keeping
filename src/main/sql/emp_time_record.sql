...
drop table employee;
create table employee(emp_id varchar(10), emp_name varchar(50), join_date date, title varchar(50));
insert into employee values ('45111', 'Amita Gunjal', '2011-01-01','Staff Product Developer');
insert into employee values ('45222', 'Kartik Ramdas Sawant', '2011-11-06','Product Developer');
insert into employee values ('45333', 'Ramdas Nana Sawant', '2013-08-01','Staff Specialist Product Developer');
insert into employee values ('45444', 'Sachin Shejwal', '2012-06-01','Staff QA');


create table employee_time_record(emp_id varchar(10), record_date date, in_time time,out_time time, floor_id int);
